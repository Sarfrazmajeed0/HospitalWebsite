<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMasterPage.Master" AutoEventWireup="true" CodeBehind="Courses.aspx.cs" Inherits="HospitalWebsite.Admin.Courses" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder" runat="server">
 ...
 <div class="card">
            <div class="card-header"><span class="add-dept-header-text fw-bold fs-5" style="color: #012970;">Courses</span><span class="d-flex float-end"><button type="button" class="add-dept-btn btn btn-primary rounded-pill" data-bs-toggle="modal" data-bs-target="#verticalycentered" onclick="editFeature(null)">Add Courses</button></span></div>
            ...
            <table class="table table-bordered mt-3">
                <thead>
                  <tr>
                    ...
                    <th scope="col">Seats Approved</th>
                ...
                <tbody>
                  <tr class="departments-table">
                    ...
                    <td ><p> Batch </p></td>
                      <td ><p> Session </p></td>
                      <td ><p> Seats Approved </p></td>
                      <td ><p> Seats Filled </p></td>
    ...
    <%--<div class="modal-dialog modal-dialog-centered modal-lg">--%>
        ...
        <div class="modal-content">
           <div class="modal-header text-center">
                <h4 class="modal-title mx-auto fw-bold" style="width: 50%; color: #012970;">Courses</h4>
            </div>
            ...
            <div class="modal-body">
                <form>
                    ...
                    <div class="form-group mb-3">
    <div class="row">
    <label for="post_title" class="col-12 col-sm-12 col-lg-3 col-form-label"><b>Batch</b></label>
    <div class="col-12 col-sm-12 col-lg-9">
        <select class="form-control form-select" id="selectInput" name="post_title" required autofocus>
            ...
            <!-- Add more options as needed -->
                    ...
                    <div class="form-group mb-3">
    <div class="row">
    <label for="post_title" class="col-12 col-sm-12 col-lg-3 col-form-label"><b>Session</b></label>
    <div class="col-12 col-sm-12 col-lg-9">
        <select class="form-control form-select" id="selectInput" name="post_title" required autofocus>
            <option value="option1">Option 1</option>
            <option value="option2">Option 2</option>
            ...
            <!-- Add more options as needed -->
                    ...
                    <div class="form-group mb-3">
                        <div class="row">
                            <label for="post_title" class="col-sm-12 col-lg-3 col-form-label"><b>Seats</b></label>
                            <div class="col-sm-12 col-lg-9">
                                <input type="text" placeholder="Title" class="form-control" id="post_title" name="post_title" required autofocus>
                            </div>
                        </div>
                                        ...
                                        <div class="form-group mb-3">
                        <div class="row">
                            <label for="post_title" class="col-sm-12 col-lg-3 col-form-label"><b>Seats Filled</b></label>
                            <div class="col-sm-12 col-lg-9">
                                <input type="text" placeholder="Title" class="form-control" id="post_title" name="post_title" required autofocus>
                            </div>
                        </div>
                    ...
                    <div class="form-group mb-3">
                     ...
                     <div class="form-group mb-3">
                         <div class="row">
                             <label for="post_title" class="col-12 col-sm-12 col-lg-3 col-form-label"><b>Remarks</b></label>
                             <div class="col-12 col-sm-12 col-lg-9">
