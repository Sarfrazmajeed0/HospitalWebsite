<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMasterPage.Master" AutoEventWireup="true" CodeBehind="Dignitaries.aspx.cs" Inherits="HospitalWebsite.Admin.Dignitaries" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder" runat="server">
 ...
 <div class="card">
            <div class="card-header"><span class="add-dept-header-text fw-bold fs-5" style="color: #012970;">Dignitaries</span><span class="d-flex float-end"><button type="button" class="add-dept-btn btn btn-primary rounded-pill" data-bs-toggle="modal" data-bs-target="#verticalycentered" onclick="editFeature(null)">Add Dignitaries</button></span></div>
    ...
    <%--<div class="modal-dialog modal-dialog-centered modal-lg">--%>
        ...
        <div class="modal-content">
           <div class="modal-header text-center">
                <h4 class="modal-title mx-auto fw-bold" style="width: 50%; color: #012970;">Dignitaries</h4>
            </div>
            ...
            <div class="modal-body">
                <form>
                  ...
                  <div class="form-group mb-3">
                    ...
                    <div class="form-group mb-3">
                        <div class="row">
                        <label for="post_title" class="col-12 col-sm-12 col-lg-3 col-form-label"><b>Order</b></label>
